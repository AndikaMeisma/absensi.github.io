  ...
  <div class="content-wrapper">
		...
		<div class="row">
				...
				<div class="card-body">
					...
					<div class="mb-2 row">
						<label for="Ttl" class="col-sm-3 col-form-label"><font face="Berlin Sans FB">Tempat Tgl Lahir</font></label>
							<div class="col-sm-8">
							
							<input type="text" name="Ttl" class="form-control" id="text" required value="<?=$pgw['Nik']; ?>">
							</div>
					</div>
					
					<div class="mb-2 row">
						<label for="Jenis_Kelamin" class="col-sm-3 col-form-label"><font face="Berlin Sans FB">Jenis Kelamin</font></label>
							<div class="col-sm-8">
							
							<input type="text" name="Jenis_Kelamin" class="form-control" id="text" required value="<?=$pgw['Jenis_Kelamin']; ?>">
							</div>
					</div>
					
					<div class="mb-2 row">
						<label for="Jalan" class="col-sm-3 col-form-label"><font face="Berlin Sans FB">Jalan</font></label>
							<div class="col-sm-8">
							
							<input type="text" name="Jalan" class="form-control" id="text" required value="<?=$pgw['Jalan']; ?>">
							</div>
					</div>
					
					
					<div class="mb-2 row">
						<label for="Rt_Rw" class="col-sm-3 col-form-label"><font face="Berlin Sans FB">RT/RW</font></label>
							<div class="col-sm-8">
							
							<input type="text" name="Rt_Rw" class="form-control" id="text" required value="<?=$pgw['Rt_Rw']; ?>">
							</div>
					</div>
					
					<div class="mb-2 row">
						<label for="Desa" class="col-sm-3 col-form-label"><font face="Berlin Sans FB">Desa</font></label>
							<div class="col-sm-8">
							
							<input type="text" name="Desa" class="form-control" id="text" required value="<?=$pgw['Desa']; ?>">
							</div>
					</div>
