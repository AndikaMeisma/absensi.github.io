<?php
session_start();
require 'function_histori_absensi/function.php';
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Histori Absensi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
			...
			<div class="card">
			  ...
			  <h3  class="card-title"><a href="histori_absensi.php"><b>Histori Absensi</b></a></h3>
			<br></br>
			...
			<form method="POST" class="filter table-responsive p-0"><b class="nama">FILTER DATA ABSENSI :</b>
				...
				<form action="" class="tambah" method="POST">
					<a class="btn btn-primary" href="function_histori_absensi/tambah_data.php"><i class="fas fa-plus"></i> Tambah Data</a>
			...
			<div  class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                 <table action="histori_absensi.php" method="get" id="example1" class="table table-bordered table-striped">
                  <thead>
                  <tr>
					...
					<th class="action"><font face="Berlin Sans FBc"></font>Action </th>
				...
				if(isset($_POST['filter'])) {
					$dari_tanggal = mysqli_real_escape_string($conn, $_POST['dari_tgl']);
					$sampai_tanggal = mysqli_real_escape_string($conn, $_POST['sampai_tgl']);
					$tampil = mysqli_query($conn,"SELECT * FROM table_scan WHERE Tanggal BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
				}else{	
				...
				<tr>
					...
					<td class="action"><font face="Berlin Sans FBc">

						<a class="mb-1 btn btn-danger btn-sm " href="function_histori_absensi/edit_data.php?id_scan=<?php echo $d['id_scan']; ?>">EDIT </a>
						
						<a class="mb-1 btn btn-warning btn-sm" href="function_histori_absensi/hapus.php?id_scan=<?php echo $d['id_scan']; ?>" onclick="return confirm('Yakin Hapus')" >HAPUS</a>
