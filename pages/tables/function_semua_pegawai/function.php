...
function tambah($data) {
	...
	$query = "INSERT INTO semua_pegawai
				VALUES
			('', '$Foto','$Nama',  '$Nik','$Ttl','$Jenis_Kelamin','$Jalan','$Rt_Rw','$Desa', '$Departemen', '$Jabatan', '$No_Wa')";
...
function edit($data) {
	...
	$query = "UPDATE semua_pegawai SET 
				Foto='$Foto', Nama='$Nama', Nik='$Nik',Ttl='$Ttl',Jenis_Kelamin='$Jenis_Kelamin',Jalan='$Jalan',Rt_Rw='$Rt_Rw',Desa='$Desa', Departemen='$Departemen', Jabatan='$Jabatan', No_Wa='$No_Wa' WHERE Id_pegawai=$id";
...
global $conn;
	...
	Jalan LIKE '%$search%' OR
	Rt_Rw LIKE '%$search%' OR
	Desa LIKE '%$search%' OR
